...
class LineChartSampleWeight extends StatefulWidget {
  ...
  @override
  State<LineChartSampleWeight> createState() => LineChartSampleWeightState();
}

class LineChartSampleWeightState extends State<LineChartSampleWeight> {
  ...
  Future<void> getInformation(String selectedIndex) async {
    List<Map<String, dynamic>> setsRepsAndDate1 =
        await DatabaseHelper().getMaxWeightForExercise(widget.exercise);
    ...
    for (var row in setsRepsAndDate) {
      ...
      double maxWeightReps = row['max_weight'].toDouble();
    ...
    return Stack(
      children: <Widget>[
        ...
        Positioned(
          ...
          child: Text(
            'Max Weight', // Your y-axis description text
            style: TextStyle(
              fontSize: 17,
